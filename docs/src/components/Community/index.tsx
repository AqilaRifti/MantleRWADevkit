                    ...
                    <div className={styles.links}>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <span className={styles.linkDescription}>Chat with the community</span>
                            </div>
                        </a>
                        <a
                        ...
                        >
                            ...
                            <div>
                                ...
                                <span className={styles.linkDescription}>Star and contribute</span>
                            </div>
                        </a>
                        <a
                        ...
                        >
                            ...
                            <div>
                                <span className={styles.linkTitle}>Twitter</span>
                                <span className={styles.linkDescription}>Follow for updates</span>
                            </div>
                        </a>
                    </div>
                </div>
